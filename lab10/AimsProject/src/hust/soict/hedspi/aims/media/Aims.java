...
public class Aims {
    public static void showMenu()
    {
        ...
        System.out.println("5.Lucky Item!!");
    ...
    public static void main(String args[]) throws LimitExceededException, PlayerException {
        ...
        DigitalVideoDisc dvd1 = new DigitalVideoDisc("Con co be be","Am nhac",1f,0,"Xuan Mai");
        ...
        Track track2 = new Track("SelfLove",0);
        Track track3 = new Track("Dont waste my time",3);
        Track track4 = new Track("Cold Dern",0);
